package com.penoder.dailynews.widget.reader;
...
import com.penoder.dailynews.widget.animation.CoverPageAnim;
import com.penoder.dailynews.widget.animation.HorizonPageAnim;
import com.penoder.dailynews.widget.animation.NonePageAnim;
import com.penoder.dailynews.widget.animation.PageAnimation;
import com.penoder.dailynews.widget.animation.ScrollPageAnim;
import com.penoder.dailynews.widget.animation.SimulationPageAnim;
import com.penoder.dailynews.widget.animation.SlidePageAnim;
        ...
        switch (pageMode) {
            ...
            case PAGE_MODE_SCROLL:
                mPageAnim = new ScrollPageAnim(mViewWidth, mViewHeight, 0,
                        DensityUtils.dp2px(PageLoader.DEFAULT_MARGIN_HEIGHT), this, mPageAnimListener);
                break;
            default:
                mPageAnim = new SimulationPageAnim(mViewWidth, mViewHeight, this, mPageAnimListener);
        }
